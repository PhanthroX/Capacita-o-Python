...
def tela_inicial():
    ...
    text1 =[
        ...
        [sg.Text('RPA CHALLENGE    |    BY PhanthroX', font='Helvitca 14 italic bold', background_color='seashell2')],
        [sg.Text('____________________________________________________________', background_color='seashell2')]
    ]                                                    
    text2 = [
        [sg.Text('',)],
    ...
    tela_inicio = sg.Window('RPA CHALLENGE - PhanthroX').layout(tela_layout)
